...
const article: WeeklyArticle = {
  ...
  summary: "사법개혁 3법 본회의 연달아 통과, 3차 상법 개정안 가결, 국민의힘 7박 8일 필리버스터",
  ...
  analysis:
    "2월 마지막 주는 사법개혁 3법이 연달아 본회의를 통과하며 22대 국회 전반기 최대 입법 쟁점이 마무리된 주였습니다. 국민의힘의 역대 최장 필리버스터에도 불구하고 민주당이 재적 과반으로 토론을 종결시키며 법안을 처리했습니다. 이는 여소야대 국회에서 다수당의 입법 추진력을 보여주는 동시에, 소수당의 절차적 저항 수단인 필리버스터의 한계도 드러냈습니다. 3차 상법 개정안(자사주 소각 의무화)은 거의 만장일치로 가결되어 밸류업 프로그램의 입법적 뒷받침이 완성되었으며, 이는 코스피 상승세의 주요 동력으로 작용하고 있습니다.",
};
