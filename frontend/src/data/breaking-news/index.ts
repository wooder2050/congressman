...
const breakingNews: BreakingNewsItem[] = [
  {
    id: "2026-04-22-by-elections-14-districts",
    title: "재보궐선거 14곳 — 민주 내일 전략공천 추가 발표, 국힘도 북구갑 전략공천 방침",
    description:
      "6·3 재보궐선거 14곳의 공천 윤곽이 빠르게 잡히고 있습니다. 민주당은 23일 공관위에서 이광재·송영길 등 수도권 전략공천 결과를 발표할 예정이며, 국민의힘도 부산 북구갑에 전략공천 방침을 확정해 무공천론을 일축했습니다. 부산 북구갑은 한동훈(무소속) vs 국힘 전략공천 후보 vs 하정우(민주, 25~26일 결정) 3파전 가능성이 부상 중입니다. 경기 평택을 조국(혁신당) 공천 확정, 울산 남구갑 전태진(민주 1호 공천) 확정.",
    date: "2026-04-22",
    category: "election",
    items: [
      {
        label: "확정 5곳",
        value:
          "인천 계양을(이재명)·충남 아산을(강훈식)·경기 안산갑(양문석)·평택을(이병진)·전북 군산김제부안갑(신영대)",
      },
      {
        label: "사퇴 예정 9곳",
        value:
          "경기 하남갑(추미애)·부산 북구갑(전재수)·충남 공주부여청양(박수현)·인천 연수갑(박찬대)·울산 남구갑(김상욱)·전북 군산김제부안을(이원택)·광주 광산을(민형배)·제주 서귀포(위성곤)·대구 미확정(4/26 본경선 결과 발표)",
      },
      {
        label: "주요 대진표",
        value:
          "부산 북구갑: 한동훈(무소속) vs 국힘 전략공천 후보 vs 하정우(민주, 25~26일 결정) · 경기 평택을: 조국(혁신당) 공천 확정",
      },
      {
        label: "민주 공천",
        value:
          "울산 남구갑: 전태진(1호 전략공천 확정) · 수도권: 이광재·송영길 전략공천 내일(23일) 공관위 발표 예정",
      },
      {
        label: "국힘 공천",
        value:
          "부산 북구갑: 전략공천 방침 확정(무공천론 일축) · 대구: 추경호 vs 유영하 본경선 4/24~25 투표 → 4/26 발표",
      },
      {
        label: "사퇴 일정",
        value: "29~30일 사직 일괄 처리 · 4/30 기한 · 5/15 후보등록 마감",
      },
    ],
    sources: [
      {
        title:
          "與 재보선 공천, 수도권 교통정리 시도…송영길·이광재·김용 등 셈법 복잡 — 파이낸셜뉴스",
        url: "https://www.fnnews.com/news/202604220501347511",
      },
      {
        title: "국힘, '한동훈 등판' 부산 북갑 전략공천 방침…'무공천론' 일축 — 네이트뉴스",
        url: "https://news.nate.com/view/20260415n32963?mid=n0200",
      },
      {
        title: "국힘 지선 후보들 '독자 선대위' 본격화…\"장동혁 역할 줄어들 것\" — 파이낸셜뉴스",
        url: "https://www.fnnews.com/news/202604210501245568",
      },
    ],
  ...
  {
    id: "2026-04-22-constitutional-amendment-d42",
    title: "개헌 국민투표 D-42 — 공고 마감 D-5, 국민의힘 이탈표 관건",
    description:
      "정부가 4월 14일 국무회의에서 개헌 국민투표 준비를 위한 예비비 196억 원을 의결했습니다. 재외국민·선상투표 명부 작성 등 사전 준비에 투입됩니다. 4월 27일 공고 기간 만료(D-5) 후 5월 4~10일 사이 본회의에서 재적의원 2/3(197명) 이상 찬성으로 가결되면 6·3 지방선거와 동시에 국민투표가 실시됩니다. 여야 6당 187명이 발의에 참여했으므로 국민의힘에서 최소 10명의 찬성이 필요하며, 김용태·조경태 의원이 호의적 입장을 밝히고 있습니다.",
    date: "2026-04-22",
    category: "politics",
    items: [
      {
      ...
      {
        label: "공고 기간",
        value: "4/7~4/27 (20일간 공고 진행 중, D-5)",
      },
      {
        label: "국회 표결",
