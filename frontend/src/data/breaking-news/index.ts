...
const breakingNews: BreakingNewsItem[] = [
  {
    id: "2026-04-21-by-elections-14-districts",
    title: "재보궐선거 14곳 확정 전망 — 공천 윤곽, 29~30일 사퇴 일괄 처리",
    description:
      "6·3 재보궐선거가 역대 최다 수준인 14곳에서 치러질 전망입니다. 기존 확정 5곳에 지방선거 출마 의원 사퇴로 9곳이 추가됩니다. 민주당은 울산 남구갑에 전태진 변호사를 1호 전략공천했고, 하남갑에 이광재 전 강원지사 공천을 유력 검토 중입니다. 부산 북구갑에는 한동훈 전 대표가 무소속으로 전입신고를 마쳤고, 민주당은 하정우 AI수석에 러브콜을 보내고 있습니다(25~26일 결정 전망). 경기 평택을은 조국 혁신당 대표의 공천이 확정되었습니다.",
    date: "2026-04-21",
    category: "election",
    items: [
      {
      ...
      },
      {
        label: "주요 대진표",
        value:
          "부산 북구갑: 한동훈(무소속) 전입 vs 하정우(민주) 러브콜 · 경기 평택을: 조국(혁신당) 공천 확정 · 경기 하남갑: 이광재(민주) 전략공천 유력",
      },
      {
        label: "공천 확정",
        value:
          "울산 남구갑: 전태진(민주 1호 전략공천) · 인천 계양을: 송영길 vs 김남준 공천 경쟁(송영길 하남갑 이동 가능성)",
      },
      {
        label: "사퇴 일정",
    ...
    sources: [
      {
        title: "광역단체장 공천 끝낸 與… 이젠 '미니 총선' 재보선 판짜기 — 머니투데이",
        url: "https://www.mt.co.kr/politics/2026/04/20/2026041920003361823",
      },
      {
        title: "與, 울산 남구갑에 전태진 공천… 이광재·송영길 재보선 투입 전망 — 파이낸셜뉴스",
        url: "https://www.fnnews.com/news/202604201829339377",
      },
      {
        title: "판 커지는 재보궐선거…수싸움도 치열해졌다 — 주간경향",
        url: "https://weekly.khan.co.kr/article/202604200600001/",
      },
    ],
  ...
  {
    id: "2026-04-21-constitutional-amendment-d43",
    title: "개헌 국민투표 D-43 — 공고 마감 D-6, 국민의힘 이탈표 관건",
    description:
      "정부가 4월 14일 국무회의에서 개헌 국민투표 준비를 위한 예비비 196억 원을 의결했습니다. 재외국민·선상투표 명부 작성 등 사전 준비에 투입됩니다. 4월 27일 공고 기간 만료(D-6) 후 5월 4~10일 사이 본회의에서 재적의원 2/3(197명) 이상 찬성으로 가결되면 6·3 지방선거와 동시에 국민투표가 실시됩니다. 여야 6당 187명이 발의에 참여했으므로 국민의힘에서 최소 10명의 찬성이 필요하며, 김용태·조경태 의원이 호의적 입장을 밝히고 있습니다.",
    date: "2026-04-21",
    category: "politics",
    items: [
      {
      ...
      {
        label: "공고 기간",
        value: "4/7~4/27 (20일간 공고 진행 중, D-6)",
      },
      {
        label: "국회 표결",
