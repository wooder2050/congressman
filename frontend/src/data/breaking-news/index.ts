...
const breakingNews: BreakingNewsItem[] = [
  {
    id: "2026-04-18-by-elections-redistricting-passed",
    title: "선거구획정 본회의 통과 — 재보선 최대 15곳, 29~30일 사퇴 처리",
    description:
      "17일 국회 본회의에서 선거구획정안이 통과되었습니다(찬성 184·반대 4·기권 25). 중대선거구제 확대와 비례대표 비율 14% 상향이 포함되었습니다. 전재수 부산시장 후보가 '4월 내 사퇴'를 공식 발표했고, 박찬대 인천시장 단수 공천이 확정되어 재보선이 최대 15곳까지 확대될 전망입니다. 29~30일에 출마 의원들의 사직을 일괄 처리합니다.",
    date: "2026-04-18",
    category: "election",
    items: [
      {
        label: "선거법 통과",
        value: "4/17 본회의 — 찬성 184·반대 4·기권 25 (중대선거구 확대·비례 14% 상향)",
      },
      {
        label: "확정 5곳",
        value:
      ...
      },
      {
        label: "사퇴 예정 4곳+",
        value:
          "경기 하남갑(추미애)·부산 북구갑(전재수·4월 내 사퇴 발표)·충남 공주부여청양(박수현)·인천 연수갑(박찬대·단수공천)",
      },
      {
        label: "사퇴 일정",
        value: "29~30일 사직 일괄 처리 · 4월 30일 기한",
      },
    ],
    sources: [
      {
        title: "선거법 개정안 국회 통과…중대선거구 확대·비례 14% 상향 — 이데일리",
        url: "https://edaily.co.kr/News/Read?mediaCodeNo=257&newsId=01256246645417432",
      },
      {
        title: "여야 합의 정치개혁 법안, 본회의 통과…광주 중대선거구 도입 — 아주경제",
        url: "https://www.ajunews.com/view/20260417233717335",
      },
      {
