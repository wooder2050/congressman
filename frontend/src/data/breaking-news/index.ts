...
const breakingNews: BreakingNewsItem[] = [
  {
    id: "2026-04-15-by-elections-mini-general",
    title: "6·3 재보궐선거 사실상 10곳 확정 — 최대 17곳 '미니 총선'",
    description:
      "6·3 지방선거와 동시에 치러지는 국회의원 재보궐선거가 사실상 10곳으로 확정되었습니다. 대통령 당선·당선무효 등으로 5곳이 확정되었고, 광역단체장 출마가 확정된 박찬대·추미애·김상욱·전재수·이원택 의원의 5곳이 추가됩니다. 제주·충남·광주전남 등 경선이 진행 중인 지역까지 포함하면 최대 17곳으로 늘어날 전망입니다. 의원직 사퇴 기한은 4월 30일입니다.",
    date: "2026-04-15",
    category: "election",
    items: [
      {
      ...
      },
      {
        label: "사퇴 예정 5곳",
        value:
          "인천 연수갑(박찬대)·경기 하남갑(추미애)·울산 남구갑(김상욱)·부산 북구갑(전재수)·전북 군산김제부안을(이원택)",
      },
      {
        label: "경선 진행 중",
      ...
      {
        label: "사퇴 기한",
        value: "D-15 — 4월 30일까지 (5월 1일 이후 사퇴 시 2027년 4월 보궐선거)",
      },
    ],
    sources: [
      {
        title: "국회의원 재보선 사실상 10곳 확정…'미니총선'급 혈전 예고 — 파이낸셜뉴스",
        url: "https://www.fnnews.com/news/202604120510500523",
      },
      {
  ...
  {
    id: "2026-04-15-constitutional-amendment-d49",
    title: "개헌 국민투표 D-49 — 예비비 196억 의결, 국민의힘 이탈표 관건",
    description:
    ...
    items: [
      ...
      {
        label: "공고 기간",
        value: "4/7~4/27 (20일간 공고 진행 중, D-12)",
      },
      {
        label: "국회 표결",
