...
const breakingNews: BreakingNewsItem[] = [
  {
    id: "2026-04-23-by-elections-14-districts",
    title: "재보궐선거 14곳 — 민주 인천 공천 확정(계양을 김남준·연수갑 송영길)",
    description:
      "민주당이 23일 공관위에서 인천 계양을에 김남준 전 청와대 대변인, 연수갑에 송영길 전 당대표를 전략공천 확정했습니다. 안산갑 김남국·하남갑 이광재 공천도 사실상 확정 분위기입니다. 부산 북구갑은 한동훈(무소속) vs 국힘 전략공천 후보 vs 하정우(민주) 3파전 가능성이 커지고 있으며, 하정우 AI수석은 출마 쪽으로 기울었다는 시사를 했습니다. 국힘 대구시장 본경선 투표가 내일(24일) 시작됩니다.",
    date: "2026-04-23",
    category: "election",
    items: [
      {
        label: "민주 공천 확정",
        value:
          "인천 계양을: 김남준(전략공천) · 인천 연수갑: 송영길(전략공천) · 울산 남구갑: 전태진(1호 전략공천) · 경기 평택을: 조국(혁신당)",
      },
      {
        label: "민주 공천 유력",
        value:
          "경기 안산갑: 김남국(사실상 확정) · 경기 하남갑: 이광재(전략공천 유력) · 김용남(보수정당 출신) 수도권 전략공천 검토",
      },
      {
        label: "주요 대진표",
        value:
          "부산 북구갑: 한동훈(무소속) vs 국힘 전략공천 후보 vs 하정우(민주, 출마 기울어짐) · 경기 평택을: 조국(혁신당) vs 범야권 단일화 변수",
      },
      {
        label: "국힘 공천",
        value:
          "부산 북구갑: 전략공천 방침 확정 · 대구시장: 추경호 vs 유영하 본경선 4/24~25 투표 → 4/26 발표",
      },
      {
        label: "사퇴 일정",
    ...
    sources: [
      {
        title: "민주, 인천 계양을 김남준·연수갑 송영길 전략공천 — 파이낸셜뉴스",
        url: "https://www.fnnews.com/news/202604231816381995",
      },
      {
        title: "이광재·송영길 어디로? 김용은?…與, 재보선 고차방정식 푼다 — 파이낸셜뉴스",
        url: "https://www.fnnews.com/news/202604230603054414",
      },
      {
        title: '하정우, 출마 기울었나…"너무 늦지 않은 타이밍에 결정 공유" — 아시아투데이',
        url: "https://www.asiatoday.co.kr/kn/view.php?key=20260423010007334",
      },
    ],
  ...
  {
    id: "2026-04-23-constitutional-amendment-d41",
    title: "개헌 국민투표 D-41 — 공고 마감 D-4, 국민의힘 이탈표 관건",
    description:
      "정부가 4월 14일 국무회의에서 개헌 국민투표 준비를 위한 예비비 196억 원을 의결했습니다. 재외국민·선상투표 명부 작성 등 사전 준비에 투입됩니다. 4월 27일 공고 기간 만료(D-4) 후 5월 4~10일 사이 본회의에서 재적의원 2/3(197명) 이상 찬성으로 가결되면 6·3 지방선거와 동시에 국민투표가 실시됩니다. 여야 6당 187명이 발의에 참여했으므로 국민의힘에서 최소 10명의 찬성이 필요하며, 김용태·조경태 의원이 호의적 입장을 밝히고 있습니다.",
    date: "2026-04-23",
    category: "politics",
    items: [
      {
      ...
      {
        label: "공고 기간",
        value: "4/7~4/27 (20일간 공고 진행 중, D-4)",
      },
      {
        label: "국회 표결",
