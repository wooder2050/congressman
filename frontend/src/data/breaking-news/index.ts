...
const breakingNews: BreakingNewsItem[] = [
  {
    id: "2026-04-20-by-elections-14-districts",
    title: "재보궐선거 14곳 확정 전망 — 29~30일 출마 의원 사퇴 일괄 처리",
    description:
      "6·3 재보궐선거가 역대 최다 수준인 14곳에서 치러질 전망입니다. 기존 확정 5곳(대통령 당선·비서실장 임명·당선무효)에 지방선거 출마 의원 사퇴로 9곳이 추가됩니다. 29~30일 사직 일괄 처리 후 최종 확정되며, 부산 북구갑(한동훈 vs 민주당)·경기 평택을(조국 출마 선언) 등 주요 대진표가 윤곽을 드러내고 있습니다. 대구는 국민의힘 시장 후보 본경선(추경호·유영하) 결과에 따라 재보궐 선거구가 결정됩니다.",
    date: "2026-04-20",
    category: "election",
    items: [
      {
      ...
      },
      {
        label: "사퇴 예정 9곳",
        value:
          "경기 하남갑(추미애)·부산 북구갑(전재수)·충남 공주부여청양(박수현)·인천 연수갑(박찬대)·울산 남구갑(김상욱)·전북 군산김제부안을(이원택)·광주 광산을(민형배)·제주 서귀포(위성곤)·대구 미확정(추경호/유영하 본경선 중)",
      },
      {
        label: "주요 대진표",
        value:
          "부산 북구갑: 한동훈(국민의힘) 전입 · 경기 평택을: 조국(혁신당) 출마 선언 · 인천 계양을: 송영길 vs 김남준 공천 경쟁",
      },
      {
        label: "사퇴 일정",
    ...
    sources: [
      ...
      {
        title: '전재수 "4월 내 의원직 사퇴" 부산북갑 재보궐 빅매치 성사되나 — 머니투데이',
        url: "https://www.mt.co.kr/politics/2026/04/17/2026041708083395841",
      },
      {
        title: "추경호·유영하, 국힘 대구시장 본경선 진출 — 뉴데일리",
        url: "https://www.newdaily.co.kr/site/data/html/2026/04/17/2026041700178.html",
      },
    ],
  ...
  {
    id: "2026-04-19-constitutional-amendment-d45",
    title: "개헌 국민투표 D-45 — 예비비 196억 의결, 국민의힘 이탈표 관건",
    description:
    ...
    items: [
      ...
      {
        label: "공고 기간",
        value: "4/7~4/27 (20일간 공고 진행 중, D-8)",
      },
      {
        label: "국회 표결",
