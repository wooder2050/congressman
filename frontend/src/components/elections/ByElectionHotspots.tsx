  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        격차가 벌어졌습니다. 5/27 박근혜 전 대통령이 부산 기장시장에서 박형준·박민식 지원유세에
        나서며 부산권 보수 결집 흐름에 가세했고, 5/28 0시부터 여론조사 공표가 금지되며 &lsquo;깜깜이
        선거&rsquo; 국면에 진입합니다. 사전투표 전날 5/28이 정치권이 보는 마지막 단일화
        데드라인이지만 부산 북갑·평택을 모두 협상 동력이 사라진 상태로, 무당층 26%(18~29세
