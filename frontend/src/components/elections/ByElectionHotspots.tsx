...
const HOTSPOTS: Hotspot[] = [
  {
    ...
    district: "북구갑",
    headline:
      'D-16 · 투표용지 인쇄일(5/18) — 단일화 1차 데드라인 직면, 부산 의원 17명 중 10명 "단일화 필요", 朴 "절대 안 한다" vs 韓 "민심이 종속변수"',
    candidates: [
      {
        name: "하정우",
        party: "더불어민주당",
    ...
    context:
      "오늘(5/18) 투표용지 인쇄 시한 = 단일화 1차 데드라인 · 사전투표(5/29~30) 전날 5/28이 2차 마지노선 · 인쇄 후엔 사퇴해도 후보 이름이 그대로 표시되어 사표 위험",
  },
  {
    region: "경기",
    district: "평택을",
    headline:
      "D-16 · 5파전 후보등록 마감 — KBS·한국리서치 5/15 '김용남·유의동·조국 오차범위 접전', 범진보 단일화 반대 46 vs 찬성 29",
    candidates: [
      {
        name: "김용남",
        party: "더불어민주당",
