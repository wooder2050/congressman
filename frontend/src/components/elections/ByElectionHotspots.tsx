  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        넘기며 부산 북갑·평택을 모두 단일화 협상이 최종 결렬돼 다자 구도가 확정됐고, 5/29~30
        사전투표 첫날 11.60%의 역대 최고 열기 속에 무당층 26%(18~29세 50%·중도층 34%)의 막판 표
        이동이 최대 변수로 떠올랐습니다.
      </p>
