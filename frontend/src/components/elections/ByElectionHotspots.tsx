...
const HOTSPOTS: Hotspot[] = [
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        party: "국민의힘",
        partyColor: "#E61E2B",
        note: 'MBC 20% · 케이스탯리서치 20% · 5/21 삭발 단행하며 "원칙 없는 단일화는 결단코 없다" 완주 의지',
      },
    ],
    context:
      '한국리서치 의뢰 MBC 코리아리서치 5/16~18(선거구민 500명, ±4.4%p) · 박민식 후보가 공식 선거운동 첫날 어머니가 직접 이발기로 머리를 깎는 삭발식을 통해 단일화 거부 의지를 굳히며 한동훈을 "침입자·잔인한 배신자"로 비판 · 한동훈은 "박민식이 하정우 당선을 막지 못하게 하는 것"이라며 반박 · 박민식 측 "실무자 협상도 없다" 입장으로 단일화 사실상 무산 · 보수 단일화가 한동훈으로 이뤄질 경우 케이스탯리서치 조사에서 하·한 38% 동률 · 박근혜 전 대통령이 5/27 오후 부산 기장시장에서 박형준 시장·박민식 북갑 후보 지원유세 단행, "부산 발전 위해 박형준·박민식 지지해달라" 메시지로 부산권 보수 결집 흐름 가세 · 5/28 0시부터 여론조사 공표 금지(공직선거법 제108조) 깜깜이 국면 진입 · 사전투표 용지 사퇴 표시 마감(5/29 18시)을 넘기며 한동훈·박민식 단일화 최종 결렬, 보수표 분산 속 다자 구도 확정 · 5/29~30 부산 북구갑 사전투표율 25.57%로 재보선 전국 평균(24.12%) 웃돌며 결집 신호 — 6/3 본투표 승부',
  },
  {
    region: "경기",
    district: "평택을",
    ...
    context:
      '한국리서치 의뢰 MBC 코리아리서치 5/16~18(선거구민 500명, ±4.4%p) · 범여권 단일 후보 적합도 조국 39% vs 김용남 36%(진보층은 조국 58% vs 김용남 33%)로 갤럽 조사 대비 역전 · 5/24 fnnews 보도에 따르면 토론회에서 조국·유의동·황교안 후보가 단일화 \'O\'를 택했으나 김용남 캠프는 "내부 논의가 거의 없다"며 부정적 · 조국 "3표 차로 이겨도 이긴다"며 단독 완주 시사, 황교안(자유와혁신) "보수 합당까지 각오" 단일화 압박했으나 김용남 "절대 단일화는 없다" 못박으며 협상 최종 결렬 · 사전투표 용지 사퇴 표시 마감(5/29 18시)을 넘겨 김재연(진보당) 포함 다자 구도 확정 · 5/28 0시부터 여론조사 공표 금지 · 5/29~30 평택을 사전투표율 18.39%로 재보선 평균(24.12%)·전국 지선(23.51%) 모두 하회, 보수 강세 험지 특성과 5파전 표 분산 영향 · 19~21대 보수 강세 험지 · 5/18 투표용지 인쇄 후 사퇴해도 후보명 그대로 표시',
  },
];
  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        사표 위험이 점차 커지는 상황입니다. 5/26 한국리서치 조사에서 국민 55%가 이번 선거를
        &lsquo;계엄세력 심판&rsquo;으로, 27%가 &lsquo;이재명 정부 심판&rsquo;으로 인식해 두 배 이상
        격차가 벌어졌습니다. 박근혜 전 대통령이 5/27 부산 기장시장(박형준·박민식)에 이어 5/28 강원
        원주·횡성(김진태) 등판으로 보수 결집 행보를 이어갔고, 5/28 0시부터 여론조사 공표가 금지되며
        &lsquo;깜깜이 선거&rsquo; 국면에 진입했습니다. 사전투표 용지 사퇴 표시 마감(5/29 18시)을
        넘기며 부산 북갑·평택을 모두 단일화 협상이 최종 결렬돼 다자 구도가 확정됐고, 5/29~30 재보선
        14곳 사전투표는 최종 24.12%(부산 북구갑 25.57%·경기 평택을 18.39%)로 마감됐습니다. 공식
        선거운동 마지막 날인 6월 2일(D-1) 여야 지도부는 지지층을 투표장으로 끌어내기 위한 막판
        총력전에 나섰고, 부산 북갑은 한동훈·박민식 보수표 분산 속 하정우(민주)의 선두 굳히기,
        평택을은 김용남(민주)·조국(혁신) 양강 5파전 구도로 본투표를 맞았습니다. 오늘 6월 3일
        본투표는 오전 6시부터 오후 6시까지 진행되며, 재보선 14곳 중 부산 북구갑·경기 평택을 두 곳은
        방송 3사 출구조사 대상에 포함돼 오후 6시 결과가 발표됩니다. 무당층 26%(18~29세 50%·중도층
        34%)의 막판 표 이동이 최대 변수로 떠올랐습니다.
      </p>
