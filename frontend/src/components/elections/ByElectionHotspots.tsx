...
const HOTSPOTS: Hotspot[] = [
  {
    ...
    district: "북구갑",
    headline:
      "MBC·코리아리서치 5/16~18 하정우 38·한동훈 33 오차범위 내 접전 — 보수 분열 속 야권 단일화 시 한동훈 47 우세",
    candidates: [
      {
        name: "하정우",
        party: "더불어민주당",
        partyColor: "#152484",
        note: "MBC 5/16~18 38% 선두 · 보수 분열 구도 굳어지며 민주당 우위",
      },
      {
        name: "한동훈",
        party: "무소속",
        partyColor: "#9ca3af",
        note: "MBC 33% · 하정우와 오차범위 내 접전 · 야권 단일 후보 적합도 47%로 우세",
      },
      {
        name: "박민식",
        party: "국민의힘",
        partyColor: "#E61E2B",
        note: 'MBC 20% · 야권 단일 후보 적합도 28% · "정치공학적 단일화는 1%도 없다" 거부',
      },
    ],
    context:
      '한국리서치 의뢰 MBC 코리아리서치 5/16~18(선거구민 500명, ±4.4%p) · 범야권 단일 후보 적합도 한동훈 47% vs 박민식 28%로 단일화 시 하정우와 오차범위 접전 가능 · 그러나 박민식 "정치공학적 단일화 1% 없다" 강경 거부, 한동훈 측은 여론조사 결과를 근거로 압박하며 양측 신경전 지속 · 5/18 투표용지 인쇄 후 사퇴해도 후보명 그대로 표시돼 사표 위험 커지는 가운데 사전투표 전날 5/28이 단일화 마지노선',
  },
  {
    region: "경기",
    district: "평택을",
    ...
    context:
      '한국리서치 의뢰 MBC 코리아리서치 5/16~18(선거구민 500명, ±4.4%p) · 범여권 단일 후보 적합도 조국 39% vs 김용남 36%(진보층은 조국 58% vs 김용남 33%)로 갤럽 조사 대비 역전 · 양측 상호 공방·감정싸움 격화로 단일화 협상 난항, 조국 "3표 차로 이겨도 이긴다"며 단독 완주 의지 · 황교안(자유와혁신) "보수 합당까지 각오" 단일화 압박했으나 유의동 측 신중론 · 19~21대 보수 강세 험지 · 5/18 투표용지 인쇄 후 사퇴해도 후보명 그대로 표시',
  },
];
