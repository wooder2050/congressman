...
const HOTSPOTS: Hotspot[] = [
  {
    ...
    context:
      '한국리서치 의뢰 MBC 코리아리서치 5/16~18(선거구민 500명, ±4.4%p) · 박민식 후보가 공식 선거운동 첫날 어머니가 직접 이발기로 머리를 깎는 삭발식을 통해 단일화 거부 의지를 굳히며 한동훈을 "침입자·잔인한 배신자"로 비판 · 한동훈은 "박민식이 하정우 당선을 막지 못하게 하는 것"이라며 반박 · 박민식 측 "실무자 협상도 없다" 입장으로 단일화 사실상 무산 · 보수 단일화가 한동훈으로 이뤄질 경우 케이스탯리서치 조사에서 하·한 38% 동률 · 박근혜 전 대통령이 5/27 부산 기장시장에서 박형준 시장 후보 지원유세 일정으로 부산권 보수 결집 흐름 가세 · 사전투표 전날 5/28이 정치권이 보는 마지막 단일화 데드라인이지만 협상 동력 사라진 상태',
  },
  {
    region: "경기",
    district: "평택을",
  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        격차가 벌어졌습니다. 사전투표 전날 5/28이 정치권이 보는 마지막 단일화 데드라인이며, 한국갤럽
        기준 무당층 26%(18~29세 50%·중도층 34%)의 막판 표 이동이 최대 변수입니다.
      </p>
