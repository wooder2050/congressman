...
const HOTSPOTS: Hotspot[] = [
  ...
  },
  {
    ...
    candidates: [
      {
        ...
        party: "더불어민주당",
        partyColor: "#152484",
        note: "갤럽 5/16~17 30% 선두 · 적극투표층에서도 31%로 우위",
      },
      {
        name: "조국",
        party: "조국혁신당",
        partyColor: "#06275E",
        note: "갤럽 23% · 김용남과 오차범위 내 접전 · 적극투표층 26% · 단일화 거부",
      },
      {
        name: "유의동",
        party: "국민의힘",
        partyColor: "#E61E2B",
        note: "갤럽 21% · 보수 단일 후보 · 김용남·조국과는 오차범위 밖 격차",
      },
      {
        name: "황교안",
        party: "자유와혁신",
    ...
    context:
      "한국갤럽 5/16~17(선거구민 500명, ±4.4%p) · 범진보 단일화 반대 46% vs 찬성 29% · 19~21대 보수 강세 험지 · 5/18 투표용지 인쇄 후 사퇴해도 후보명 그대로 표시",
  },
];
