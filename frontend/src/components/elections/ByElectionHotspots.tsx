  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        &lsquo;깜깜이 선거&rsquo; 국면에 진입했습니다. 사전투표(5/29~30) 하루 전인 5/28까지도 부산
        북갑·평택을 모두 단일화 협상 동력이 사라진 채 다자 구도가 굳어졌고, 무당층 26%(18~29세
        50%·중도층 34%)의 막판 표 이동이 최대 변수입니다.
      </p>
