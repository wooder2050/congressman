  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        14곳 사전투표는 최종 24.12%(부산 북구갑 25.57%·경기 평택을 18.39%)로 마감됐습니다. 본투표를
        이틀 앞둔 6월 1일 여야 지도부는 부동층을 투표장으로 끌어내기 위한 막판 무박 총력전에
        돌입했고, 무당층 26%(18~29세 50%·중도층 34%)의 막판 표 이동이 최대 변수로 떠올랐습니다.
      </p>
