...
const HOTSPOTS: Hotspot[] = [
  {
    ...
    context:
      "한국리서치 의뢰 MBC 코리아리서치 5/16~18(선거구민 500명, ±4.4%p) · 범야권 단일 후보 적합도 한동훈 47% vs 박민식 28% · 단일화 시 하정우와 오차범위 접전 가능하나 한동훈·박민식 간 신경전으로 협상 난항 · 5/18 투표용지 인쇄 후 사퇴해도 후보명 그대로 표시 · 사전투표 전날 5/28이 단일화 마지노선",
  },
  {
    region: "경기",
    district: "평택을",
    ...
    context:
      "한국리서치 의뢰 MBC 코리아리서치 5/16~18(선거구민 500명, ±4.4%p) · 범여권 단일 후보 적합도 조국 39% vs 김용남 36%(진보층은 조국 58% vs 김용남 33%) · 김용남·조국 간 상호 공방으로 단일화 협상 난항 · 19~21대 보수 강세 험지 · 5/18 투표용지 인쇄 후 사퇴해도 후보명 그대로 표시",
  },
];
