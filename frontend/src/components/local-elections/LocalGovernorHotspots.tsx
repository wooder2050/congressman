  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        국면이 이어지는 가운데, 5/29~30 양일간 진행된 사전투표는 최종 23.51%로 역대 지방선거
        최고치를 경신하며 사전투표 참여자 1천만 명을 처음으로 돌파했습니다. 전남 38.95%·전북 35.05%
        등 호남권 강세, 대구 18.65% 최저로 영·호남 온도 차가 뚜렷합니다. 공식 선거운동 마지막 날인
        6월 2일(D-1) 여야는 지지층을 투표장으로 끌어내기 위한 막판 총력전에 나서, 정청래 민주당
        총괄상임선대위원장은 강원 정선·영월에서 경기 용인을 거쳐 서울 청계광장에서 &ldquo;이재명
        정부에 힘을 싣는 선거&rdquo;라며 대장정을 마무리했고, 장동혁 국민의힘 상임선대위원장은 충남
        청양·공주·당진을 돈 뒤 천안에서 &ldquo;충남 파이널&rdquo;을 열고 &ldquo;오만한 이재명 정권을
        심판해달라&rdquo;며 보수 결집을 촉구했습니다. 강성 이미지의 양당 위원장 모두 대구·부산
        격전지 유세는 자제하고 중도층이 많은 충청·서울에 집중했으며, 이재명 현직 대통령의 국정
        안정론과 이명박(서울·부산)·박근혜(대구·영남) 전직 대통령의 보수 결집이 맞붙는 &lsquo;현직 vs
        전직 대통령 대리전&rsquo; 양상으로 전개됐습니다. 오늘 6월 3일 본투표는 오전 6시부터 오후
        6시까지 진행되며, 투표 마감과 동시에 방송 3사 공동 출구조사가 발표되고 오후 6시 20분께
        개표가 시작됩니다. 사전투표 23.51%(역대 최고)에 본투표 표심이 더해진 격전지 승부는 자정 무렵
        윤곽이, 박빙 지역은 새벽 3~4시께 가려질 전망입니다.
      </p>
