...
const HOTSPOTS: Hotspot[] = [
  ...
  },
  {
    ...
    context:
      'MBC·코리아리서치 5/16~17 부산 18세 이상 800명 · 전재수 44% vs 박형준 38%로 격차 6%p · 오차범위(±3.5%p) 내 경합 · 응답자 90%가 "지지 후보 계속 지지" 답해 막판 표 결집·투표율이 당락 가를 변수 · 박근혜 전 대통령이 탄핵 후 9년 만에 5/23 대구·5/25 충청에 이어 5/27 오후 부산 기장시장 방문해 박형준 시장·박민식 북갑·정명시 기장군수 후보 지원유세 단행("부산 발전 위해 박형준 지지해달라") — 보수 결집 효과와 중도 이탈 우려 동시 거론 · 5/28 0시부터 여론조사 공표 금지로 깜깜이 국면 진입 · TV토론 종료 후 페이스북 공방·정책 검증전으로 국면 전환',
  },
  {
    region: "충남",
    title: "충남지사",
  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        따라붙은 가운데, 박근혜 전 대통령이 탄핵 후 9년 만에 5/23 대구·25 충청·27 부산 기장시장
        등판에 이어 28일 강원 일정으로 보수 결집에 나섰습니다. 5/28 0시부터 여론조사 공표가 금지되며
        깜깜이 국면에 돌입하고, 사전투표(5/29~30)를 앞둔 막판 표심 결집 총력전이 이어집니다.
      </p>
