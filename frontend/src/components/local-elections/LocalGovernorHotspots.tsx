  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        등 호남권 강세, 대구 18.65% 최저로 영·호남 온도 차가 뚜렷합니다. 본투표를 이틀 앞둔 6월
        1일 여야는 부동층을 투표장으로 끌어내기 위한 막판 총력전에 돌입해, 정청래 민주당 총괄상임선대위원장은
        충남 천안·충북 괴산·경북 안동·울산 남구로 이어지는 충청·영남 종단 유세에, 장동혁 국민의힘
        상임선대위원장은 제주·울산을 도는 험지 공략에 나섰습니다. 이명박 전 대통령은 5/31 부산
        해운대시장에서 박형준 후보를, 박근혜 전 대통령은 같은 날 대구 서문시장에서 추경호 후보를
        지원하며 보수 텃밭 결집에 가세했습니다. 1천만 사전투표 표심이 6월 3일 본투표 최종 투표율과
        격전지 승부에 어떤 영향을 미칠지 주목됩니다.
      </p>
