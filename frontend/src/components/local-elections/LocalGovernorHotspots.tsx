  ...
  },
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        party: "국민의힘",
        partyColor: "#E61E2B",
        note: "現 부산시장 · MBC 38% · 격차 14%p→6%p로 좁힘 · 박근혜 5/27 기장 지원유세 예정",
      },
    ],
    context:
      'MBC·코리아리서치 5/16~17 부산 18세 이상 800명 · 전재수 44% vs 박형준 38%로 격차 6%p · 오차범위(±3.5%p) 내 경합 · 응답자 90%가 "지지 후보 계속 지지" 답해 막판 표 결집·투표율이 당락 가를 변수 · 박근혜 전 대통령이 탄핵 후 9년 만에 5/23 대구·5/25 충청 유세 후 5/27 부산 기장시장에서 박형준 지원유세 — 보수 결집 효과와 중도 이탈 우려 동시 거론 · TV토론 종료 후 페이스북 공방·정책 검증전으로 국면 전환',
  },
  {
    region: "충남",
    title: "충남지사",
  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        따라붙은 가운데, 박근혜 전 대통령이 탄핵 후 9년 만에 5/23 대구·25 충청을 거쳐 27 부산·28
        강원 일정으로 보수 결집에 나섰습니다. 사전투표(5/29~30)를 앞두고 막판 표심 결집 총력전이
        이어집니다.
      </p>
