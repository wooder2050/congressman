  ...
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-(--color-text-secondary)">
        ...
        총괄상임선대위원장은 강원 정선·영월에서 경기 용인을 거쳐 서울 청계광장에서 "이재명 정부에
        힘을 싣는 선거"라며 대장정을 마무리했고, 장동혁 국민의힘 상임선대위원장은 충남
        청양·공주·당진을 돈 뒤 천안에서 "충남 파이널"을 열고 "오만한 이재명 정권을 심판해달라"며
        보수 결집을 촉구했습니다. 강성 이미지의 양당 위원장 모두 대구·부산 격전지 유세는 자제하고
        중도층이 많은 충청·서울에 집중했으며, 이재명 현직 대통령의 국정 안정론과 이명박(서울·부산)·
        박근혜(대구·영남) 전직 대통령의 보수 결집이 맞붙는 '현직 vs 전직 대통령 대리전' 양상으로
        전개됐습니다. 1천만 사전투표 표심이 6월 3일 본투표 최종 투표율과 격전지 승부에 어떤 영향을
        미칠지 주목됩니다.
      </p>
