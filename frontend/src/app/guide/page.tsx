...
export const metadata: Metadata = {
  ...
  description:
    "국회 법안 통과 절차를 단계별로 쉽게 설명합니다. 법안 발의 → 위원회 심사 → 본회의 표결 → 법률 공포까지 입법 과정 전체를 안내합니다. 본회의 통과 의미, 의원입법과 정부입법의 차이, 대안반영폐기 뜻도 함께 알아보세요.",
  alternates: { canonical: "https://www.lawmake.kr/guide" },
  openGraph: {
    title: "국회 법안 통과 절차 — 발의부터 본회의 의결까지",
    description:
      "법안 발의 → 위원회 심사 → 본회의 표결 → 법률 공포. 국회 법안 통과 절차를 단계별로 쉽게 설명합니다.",
